...
public interface TimeSlotRepository extends CrudRepository<TimeSlot, Long> {
    ...
    @Transactional
    @Modifying
    @Query("DELETE FROM TimeSlot t WHERE t.appointmentGroupId = :appointmentGroupId")
    void deleteByAppointmentGroupId(@Param("appointmentGroupId") Long appointmentGroupId);
}